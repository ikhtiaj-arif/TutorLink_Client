    ...
    return (
        <TLContainer className="pt-32">
            <div className="max-w-6xl mx-auto ">
                <h1 className="text-4xl font-semibold text-left text-gray-900 mb-12">Frequently Asked Questions</h1>
                        ...
                        <div>
                            <div className="border-b">
                                ...
                                <AnimatePresence>
                                    {activeIndex === 0 && (
                                        <motion.div
                                            className="py-2 px-6 text-gray-600 bg-gray-200 mx-6 rounded-2xl mb-2"
